...
const ZENTRA_PREMIUM_MODEL = process.env.ZENTRA_PREMIUM_MODEL || "gpt-4.1-mini";
const ZENTRA_PREMIUM_FINAL_MODEL = process.env.ZENTRA_PREMIUM_FINAL_MODEL || "gpt-4.1";
